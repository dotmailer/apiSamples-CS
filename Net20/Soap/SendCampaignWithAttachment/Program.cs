...
using dotMailer.SendCampaignWithAttachment.dotMailer;
...
namespace dotMailer.SendCampaignWithAttachment
{
    class Program
    {
        ...
        {
            _client.AttachDocumentToCampaign(campaign.Id, true, document);
        }
        ...
        private static ApiDocument UploadDocument(int documentFolderId)
        {
            ...
            ApiDocument uploadedDocument = _client.UploadDocument(documentFolderId, true, fileName, data);
        ...
        private static ApiDocumentFolder CreateDocumentFolder()
        {
            ...
            ApiDocumentFolder result = _client.CreateDocumentFolder(0, true, documentFolder);
            return result;
        }
